...
// Array - ichki tartibga ega bo'lgan maxsus object
...
const listArr3 = ["a", "b", "c", "d", "e", 1, 2, 3, 4, 5, 6, 7, true, null, undefined, false];
...
// -----------------------------
// Properties: length
// Commonly we use these regular methods of array:
...
const pushArr1 = ["Azizbek", "Abdugani", "Kamron"];
...
const spliceArr3 = ["Patrick", "Martin"];
...
const spliceArr4 = ["Bolta", "Tesha", "Arra", "Ketmon"];
spliceArr4.splice(0, 3, "Alex", "Andrew", "Julian", "Joe", "Steve", "Kevin", "Felix", "Adam", "Max", "Jayson");

console.log(`Students of MIT 19 are ${spliceArr4.sort().join(", ")}`);
