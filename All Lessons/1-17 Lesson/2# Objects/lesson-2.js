...
//Hozirga qadar Primtive Variable'larni ko'rib chiqdik!

// Primitive Variables:
// Primitive Variables'da reference (manzil) bo'lmaydi lekin value bo'ladi

const isNamee = "Alex"; // String
const isNumber = 23; // Number
...
// Does not change anything belongs to person 3:
console.log(
	"and Old person's name changed by spread operator:",
	personObjVar3.name
);

// It changes the name of the third object variable:
console.log(
